...
urlpatterns = [
    ...
    path('listar_rutas/ver_detalle_viaje_ruta/<str:nombre>/',views.ListarRuta.mostrar_detalle_viaje_ruta),
    ...
    path('listar_vehiculos/ver_detalle_viaje_vehiculo/<patente_vehiculo>/',views.ListarVehiculos.mostrar_detalle_viaje_vehiculo),
    ...
    path('listar_ciudades/ver_detalle_viaje_ciudad/<int:codigo_postal>/',views.ListarCiudad.mostrar_detalle_viaje_ciudad),
    ...
    path('listar_choferes/ver_detalle_viaje_chofer/<int:dni>/',views.ListarChofer.mostrar_detalle_viaje_chofer),
